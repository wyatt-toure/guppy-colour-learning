...
can also be seen in
[analysis-experiment-2.Rmd](https://github.com/wyatt-toure/guppy-colour-learning-project/blob/main/analysis-experiment-2.Rmd).
If you only want to see the results you can go straight to the [Models](#models)
section.
...
New variables and measures need to be created from the variables we have in the
