...
`r report_ci(test_data_simple_contrasts, rounding = 0)[2]`).
...
`r report_ci(test_data_simple_contrasts, rounding = 0)[3]`).
...
`r report_ci(test_data_simple_contrasts, rounding = 0)[4]`).
...
`r report_ci(test_data_simple_contrasts, rounding = 0)[5]`).
...
`r report_ci(test_data_simple_contrasts, rounding = 0)[6]`).
