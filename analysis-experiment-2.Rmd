...
guppies have a preference that differs significantly from zero: (p =
...
differs significantly from zero: (green-trained green object preference: \_, p =
`r contrast_against_zero$p.value[6]` ; blue-trained blue object preference-, p =
...
`r report_ci(test_data_contrasts, rounding = 0)[4]`). There is a trend for
...
green-trained nor blue-trained guppies have a rewarding object preference that
differs significantly from zero: (p = `r contrast_against_zero$p.value[10]`;
blue-trained blue object preference: p = `r contrast_against_zero$p.value[9]`).
