...
contrast_against_zero$trial <- c("Initial",
                                 "Initial",
                                      "Probe 1",
                                 "Probe 1",
                                      "Generalization 1",
...
`r report_ci(test_data_simple_contrasts, rounding = 0)[2]`). Green-trained guppies have a preference that differs significantly from zero: (p = `r contrast_against_zero$p.value[4]`) but blue-trained guppies do not (p = `r contrast_against_zero$p.value[3]`).
...
`r report_ci(test_data_simple_contrasts, rounding = 0)[3]`). Neither green-trained nor blue-trained guppies have a rewarding object preference that differs significantly from zero: (green-trained green object preference: _, p = `r contrast_against_zero$p.value[6]` ; blue-trained blue object preference-, p = `r contrast_against_zero$p.value[5]`).
...
`r report_ci(test_data_simple_contrasts, rounding = 0)[4]`). Green-trained guppies have a preference that differs significantly from zero: (p = `r contrast_against_zero$p.value[8]`) but blue-trained guppies do not (p = `r contrast_against_zero$p.value[7]`).
...
`r report_ci(test_data_simple_contrasts, rounding = 0)[5]`). Neither green-trained nor blue-trained guppies have a rewarding object preference that differs significantly from zero: (p = `r contrast_against_zero$p.value[10]`; blue-trained blue object preferene:  p = `r contrast_against_zero$p.value[9]`).
...
`r report_ci(test_data_simple_contrasts, rounding = 0)[6]`). Green-trained guppies have a preference that differs significantly from zero: (p `r contrast_against_zero$p.value[12]`) but blue-trained guppies do not (p = `r contrast_against_zero$p.value[11]`).
