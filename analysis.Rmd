...
my_data <- my_data %>%
  group_by(id) %>%
  mutate(rewarding.object.preference.prop = (time.with.trained.object/(time.with.trained.object + time.with.untrained.object)))
...
ggplot(
  ...
  aes(
    x = trial,
    y = rewarding.object.preference.prop,
    color = rewarding.object.colour,
    shape = rewarding.object.colour
  )
) +
...
ggsave(
  filename = "esm-model-3-prop-test-data-pref-plot.png",
  path = "figs/",
  device = "png",
  dpi = 300
)
...
# Saving plot to figs directory
ggsave(
  filename = "ESM-model-4-residual-plot.png",
  plot = (plot(simulationOutput)),
  path = "figs/residual-plots/",
  device = "png",
  dpi = 300
...
ggsave(
  filename = "esm-model-4-training-data-ate-plot.png",
  path = "figs/",
  device = "png",
  dpi = 300
)
