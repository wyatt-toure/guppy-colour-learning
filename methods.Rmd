...
On the first day, guppies were placed in the test tank with both objects but empty food strips to measure preferences at a baseline. Training then occurred once daily between 10h00 to 16h00 for 20 days. During training the location of the rewarding object (left or right) was randomized across days and individuals. That is, only the object’s appearance provided a reliable cue to food location. On the 21st day an unreinforced ‘probe’ test was given where new duplicates of the objects were presented with empty plastic strips attached to them. This unreinforced trial was used to assess whether learning had occurred. At test, equal number of individuals were presented with the formerly-rewarded object on the left and right side. 
...
1.	We transferred the guppy from the home tank to the test tank where the water level was 8 cm via an opaque plastic cup where the green and blue objects had already been placed.
...
3.	After acclimation the release glass was lifted and the guppies given 5 minutes to move about the tank and feed from the objects.
4. After the 5 minutes the guppy was transferred back to the home tank via the opaque plastic cup.
...
1.	We transferred the guppy from the home tank to the test tank where the water level was 8 cm via an opaque plastic cup where the green and blue objects had already been placed. A food strip with a gelatine, flake food, brine shrimp reward mixture on it was attached depending on the rewarding object treatment the guppy was in.
2.	Guppies were allowed to acclimate in a 20 cm tall, open-ended glass holding cylinder (7 cm diameter) after being transferred into the test tank for 120 seconds.
3.	After acclimation the release glass was lifted and the guppies given 5 minutes to move about the tank and feed from the objects.
4. After the 5 minutes the guppy was transferred back to the home tank via the opaque plastic cup.
...
6. Wait one hour for strips to fix onto the plastic strips
