...
Throughout training, over the 20 trials, guppies increased their relative preference for the rewarded object by `r tidy_fit$estimate[3] %>% round(3)` seconds each trial (Figure \@ref(fig:novel-pref-plot), p `r formatted_p[3]`). There was also a significant effect of rewarding object colour (p `r formatted_p[2]`). During training green-rewarded guppies expressed a stronger preference for their rewarded object (the green object) than blue-rewarded guppies did for the blue object However, there was no interaction effect between rewarding object colour and trial (p `r formatted_p[4]`) suggesting there was no difference in the rate of learning between the treatments
...
objects_image = magick::image_read('docs/images/objects.jpg')
ggdraw() + draw_image(objects_image, scale = 0.2, x = 0.3, y =0.45) + draw_plot(plot)
```
