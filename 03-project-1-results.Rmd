...
p1 = ggplot(training.data, 
  ...
  theme(legend.position = "top", axis.text=element_text(size=14), axis.title=element_text(size=14,face="bold"), 
        plot.title = element_text(size=16, hjust=0.5), panel.border = element_rect(colour = "black", fill=NA, size=1), axis.line.x = element_blank(), axis.line.y = element_blank()) + scale_color_manual(values=c('#dd4124','#0f85a0')) + 
...
p2 = ggplot(training.data, 
  ...
  geom_flat_violin(aes(fill = ate),position = position_nudge(x = .25, y = 0),adjust = 1, alpha = 0.6, trim = TRUE, color=NA) + stat_summary(
    ...
    shape = 15) +
  stat_summary(geom = 'errorbar', 
               fun.data = 'mean_ci', position = position_dodge(width=0), width = 0.2) + xlab("Ate?") + ylab("Rewarding object preference (sec)")+
  theme(legend.position = "none", axis.text=element_text(size=14), axis.title=element_text(size=12.5,face="bold"), 
        plot.title = element_text(size=16, hjust=0.5), axis.line.y = element_blank(), axis.line.x = element_blank(), axis.text.y = element_blank(), axis.ticks.y =  element_blank(), axis.title.y = element_blank(),panel.border = element_rect(colour = "black", fill=NA, size=1)) + scale_color_manual(values=c('#dd4124','#0f85a0')) + scale_fill_manual(values=c('#dd4124','#0f85a0')) + 
  geom_hline(yintercept = 0, linetype = 'dashed') + ylim(-310,310)
...
ggplot(my.feeding.data,
  ...
  ylab('Rewarding object preference')+xlab('Trial') + theme_cowplot()+ guides(fill = FALSE, colour = FALSE) + ylab('Rewarding object preference (sec)') + xlab("Rewarding object colour") + labs(col = "Rewarding object colour") +
  theme(legend.position = "top", axis.text=element_text(size=14), axis.title=element_text(size=14,face="bold"), 
