...
To determine whether X was different from Y I conducted post-hoc comparisons of the mean. 
...
There is a fish that did not eat during any trials, however removing this individual does not change the results. 
...
Moreover, as I demonstrate in the next model including the amount of trials fed as a covariate in the model does not change the results.
