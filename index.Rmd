...
site contains the code, model outputs, data tables, and residual diagnostics for
the analyses in the manuscript as well as detailed protocols and sample videos
for the experiment. The Rmarkdown scripts to reconstruct this site are available
at the [GitHub repository for this
