...
We find that only green-trained guppies during the final test trial display a
rewarding object preference that is significantly different from chance (green
object preference: `r percent_contrast_against_chance$response[4] * 100` ±
`r percent_contrast_against_chance$SE[4] * 100`%, p
`r percent_contrast_against_chance$p.value[4]`) which is the same result we find
when using a difference measure.
