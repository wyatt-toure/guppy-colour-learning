...
(green object preference: `r contrast_against_chance$emmean[4] %>% round(0)` ± `r contrast_against_chance$SE[4] %>% round(0)` seconds, p `r contrast_against_chance$p.value[4]`).
